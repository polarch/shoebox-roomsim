function [abs_echograms, echograms] = compute_echograms_arrays(room, src, rec, abs_wall, limits)
...
for ns = 1:nSrc
    for nr=1:nRec
        ...
        % compute echogram
        abs_echograms(ns, nr, :) = absorption_module(echograms(ns,nr), abs_wall, limits);
    end
end
